...
// Move all Three.js setup into onMounted lifecycle hook
onMounted(() => {
    ...
    const cube = new THREE.Mesh(cubeGeometry, cubeMaterial) as THREE.Mesh & {
        isRedirectObject?: boolean;
    };
    scene.add(cube);
    ...
    onBeforeUnmount(() => {
        ...
        renderer.dispose();
        // Clean up other Three.js resources...
    });
});
</script>
